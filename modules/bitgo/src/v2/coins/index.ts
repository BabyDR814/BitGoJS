...
const { Ofc, OfcToken, Susd, FiatUsd, FiatEur, FiatGBP, FiatAED, FiatSGD, Tsusd, TfiatUsd, TfiatEur, TfiatGBP, TfiatAED, TfiatSGD } = coins;
export { FiatAED, FiatEur, FiatGBP, FiatSGD, FiatUsd, Ofc, OfcToken, Susd, TfiatAED, TfiatEur, TfiatGBP, TfiatSGD, TfiatUsd, Tsusd };
